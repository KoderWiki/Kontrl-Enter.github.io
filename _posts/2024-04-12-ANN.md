...
> Input Layer is recieved input by dataset
> The number of input variables and the number of input nodes are the same
> When counting the number of layers of a neural network, the input layer is not included
